...
const Commitment = () => {
    const commitmentData = [
        ...
        },
        {
            ...
            desc: "With the support of quality management and safety certifications, we are confident that our services meet high standards. Swara Visual is committed to excellence.",
            ...
            <div className="max-w-7xl mx-auto px-10 pb-32">
                <div className="max-w-4xl mb-24">
                    <p className="text-2xl md:text-4xl font-light leading-tight text-gray-300">
                        ...
                        At Swara Visual, each member of our workforce is trained
