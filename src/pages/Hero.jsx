...
const Hero = () => {
    ...
    const clients = [
        { name: "SAMSUNG", img: "/image/industry/samsung1.png" },
        { name: "BCA", img: "/image/industry/BCA.png" },
        { name: "WALL'S", img: "/image/industry/wall's.png" },
        { name: "WhatsApp", img: "/image/industry/whatsapp.png" },
        { name: "Wardah", img: "/image/industry/wardah.png" },
        { name: "POCARI", img: "/image/industry/pocari.png" },
        { name: "NET.", img: "/image/industry/NET.png" },
        { name: "Emina", img: "/image/industry/emina.png" },
        { name: "Baseus", img: "/image/industry/baseus.jpeg" },
        { name: "KOMINFO", img: "/image/industry/kominfo.png" },
        { name: "Facebook", img: "/image/industry/facebook.png" },
        { name: "WeTV", img: "/image/industry/weTV.png" },
    ];
    ...
    const steps = [
        {
            ...
            img: "/image/planning/1.png", // Ganti dengan gambar aslimu
        },
        {
    ...
    const comparisonImages = {
        before: "/image/before-after/before.png",
        after: "/image/before-after/after.png",
    };
            ...
            <div className="relative">
                ...
                <section className="bg-black py-24 px-10 text-white">
                    <div className="max-w-7xl mx-auto text-center mb-16">
                        <h2 className="text-5xl font-bold mb-4">
                            Seamless Event Planning with Swara Visual
                        </h2>
                        <p className="text-gray-400 max-w-2xl mx-auto">
                            Swara Visual goes beyond creating events—we craft
                ...
                <section className="bg-black py-24 px-10 text-white">
                    <div className="max-w-7xl mx-auto text-center mb-16">
                        <h2 className="text-5xl font-bold mb-4">
                            Magic Happens With Swara Visual
                        </h2>
                        <p className="text-gray-400 max-w-2xl mx-auto">
                            Feel the magic, embrace the vibe. With Swara Visual
                ...
                <section className="bg-black py-24 px-10 text-white">
                    <div className="max-w-7xl mx-auto text-center mb-16">
                        ...
                        <p className="text-[#CCFF00] max-w-3xl mx-auto text-lg leading-relaxed">
                            ...
                            event's vision to life. With Swara Visual,
                            experience the synergy of creativity,
                            state-of-the-art technology, and meticulous planning
                            that ensures your occasion shines.
                        </p>
                    </div>
